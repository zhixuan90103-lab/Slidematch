...
- 变色子：纯普通子 ≥5 生成（路径飞入队尾弹出）；划入可换色；滑动 Additive 标散子；松手倒数选中后按路径长度散消。≥10 出魔法子。魔法：本划全同色，抬手只消路径。路径含魔法则变色散消不触发。  
...
排行榜。对角 X 交叉阶段 B 允许。心 / 星素材在包里，盘面三色不用。旧点心（饼干 / 甜甜圈 / 果冻 / 马卡龙）已删。
