...
从 [AGENTS.md](./AGENTS.md) 进。规范地图与当前规格：[docs/SPEC.md](./docs/SPEC.md)。玩法真源 [docs/DESIGN.md](./docs/DESIGN.md)。数字 `src/game/design.ts`。
...
应看到：奶油舞台、九宫框、6×6 黏土棋子（水滴 / 叶 / 太阳 / 心 / 星）、薰衣草浅格、顶栏 SCORE。可划、抬手消除、下落。齿轮打开设置。
